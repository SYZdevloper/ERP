...
export function NotesPanel({ isReadOnly = false }: { isReadOnly?: boolean }) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg overflow-hidden flex flex-col">
      ...
      <div className="p-4">
        {isReadOnly ? (
          <div className="w-full min-h-[120px] text-sm text-slate-700 whitespace-pre-wrap">
          ...
          <textarea 
            ...
            className="w-full min-h-[120px] resize-none border border-slate-200 rounded-md p-3 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
