    ...
    <SelectPrimitive.Trigger
      ...
      onFocus={(e) => {
        if (e.target.getAttribute("data-state") === "closed") {
          // Open it by simulating a space or down arrow, or just click
          // Since it's Radix, clicking it toggles it.
          // Using setTimeout to allow focus to settle before clicking, avoids some blur issues
