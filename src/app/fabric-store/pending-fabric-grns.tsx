...
const MOCK_PENDING_FABRIC_GRNS = [
  {
    id: "FPO-5011",
  ...
  },
  {
    ...
    qty: "3,920 Pcs",
    poDate: "2026-06-02",
    expectedDelivery: "2026-08-04", // Set to a recent date to trigger delay
  },
  {
    id: "FPO-5021",
...
export function PendingFabricGRNs() {
  const [searchQuery, setSearchQuery] = useState("");

  const filtered = MOCK_PENDING_FABRIC_GRNS.filter(
    (item) =>
          ...
          <Table>
            <TableHeader className="bg-slate-50 sticky top-0 z-10 shadow-sm">
              <TableRow>
                ...
                <TableHead className="px-6 py-3 w-[20%]">Material</TableHead>
                  ...
                  return (
                    <TableRow key={item.id} className="hover:bg-slate-50/50">
                      ...
                      <TableCell className="px-6 py-3 text-center">
                        <Link href={`/fabric-store/grn/create?po=${item.id}`}>
